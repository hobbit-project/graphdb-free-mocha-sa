 ...
 *
 */
public abstract class AbstractSystemAdapter1 extends AbstractPlatformConnectorComponent
     ...
     */
    public AbstractSystemAdapter1(int maxParallelProcessedMsgs) {
